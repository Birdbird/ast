<div class="span4">
	<div class="accordion">
		...
		<p>
			...
			<span class="organization"><a href="<?php echo $this->createUrl('about',array('id'=>4))?>">常委会委员</a></span><span  class="organization"><a href="<?php echo $this->createUrl('about',array('id'=>5))?>">全委会委员</a></span>
		...
		<h3>历届主席</h3>
		<p>
			<span><a href="#">王高顺</a><a href="#">朱玉兰</a><a href="#">张  康</a><a href="#">秦素萍</a>
			<a href="#">曹思平</a><a href="#">高  静</a><a href="#">仇洪泽</a><a href="#">陈治环</a>
			<a href="#">顾建平</a></span>
		</p>
	</div>
</div>
